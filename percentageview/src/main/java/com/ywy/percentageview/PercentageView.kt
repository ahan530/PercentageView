...
class PercentageView : android.view.View {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        Log.e(PercentageView.TAG, "宽: $widthSize 高：$heightSize")
            ...
            MeasureSpec.EXACTLY -> { //父容器已经为子容器设置了尺寸,子容器应当服从这些边界,不论子容器想要多大的空间.
                when (heightMode) {
                    MeasureSpec.EXACTLY -> {
                        ...
                        Log.e(PercentageView.TAG + "宽高一定", "宽: $widthSize 高：$heightSize")
                    }
                    MeasureSpec.AT_MOST, MeasureSpec.UNSPECIFIED -> {
                        setMeasuredDimension(widthSize, mMinHeight.toInt())
                        Log.e(PercentageView.TAG + "宽一定,高不定", "宽: $widthSize 高：$mMinHeight")
                    }
                }
            }
            MeasureSpec.AT_MOST -> { //子容器可以是声明大小内的任意大小 wrap
                when (heightMode) {
                    MeasureSpec.EXACTLY -> {
                        ...
                        Log.e(PercentageView.TAG + "宽wrap高一定", "宽: $mMinWidth 高：$heightSize")

                    }
                    MeasureSpec.AT_MOST, MeasureSpec.UNSPECIFIED -> {
                        setMeasuredDimension(mMinWidth.toInt(), mMinHeight.toInt())
                        Log.e(PercentageView.TAG + "宽高均wrap", "宽: $mMinWidth 高：$mMinHeight")
                    }
                }
            }
