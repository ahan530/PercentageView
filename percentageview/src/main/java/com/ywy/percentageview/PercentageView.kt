...
class PercentageView : android.view.View {
    ...
    private fun initData(context: Context?, attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            obt?.getColor(R.styleable.PercentageView_textLeftColor, mTextLeftColor)
                ?.let {
                    mTextLeftColor = it
                }
